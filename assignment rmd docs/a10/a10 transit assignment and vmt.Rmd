...
write.csv(drive_dist, here("assignment rmd docs", "a10", "drive_dist.csv"))
write.csv(drive_dist_alt, here("assignment rmd docs", "a10", "drive_dist_alt.csv"))
write.csv(route_trips, here("assignment rmd docs", "a10", "route_trips.csv"))
write.csv(route_trips_alt, here("assignment rmd docs", "a10", "route_trips_alt.csv"))
write.csv(ped_dist, here("assignment rmd docs", "a10", "ped_dist.csv"))
write.csv(bike_dist, here("assignment rmd docs", "a10", "bike_dist.csv"))
```
