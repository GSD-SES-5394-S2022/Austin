...
PMT_car <- skims %>%
  ...
  summarize(total_SOV_miles_HBW = sum(PMT_SOV_HBW),
            total_HOV_miles_HBW = sum(PMT_HOV_HBW),
            total_SOV_miles_HBO = sum(PMT_SOV_HBO),
...
PMT_walk <- skims %>%
  ...
  summarize(total_walk_miles_HBW = sum(PMT_walk_HBW),
            total_walk_miles_HBO = sum(PMT_walk_HBO),
...
PMT_bike <- skims %>%
  ...
  summarize(total_bike_miles_HBW = sum(PMT_bike_HBW),
            total_bike_miles_HBO = sum(PMT_bike_HBO),
