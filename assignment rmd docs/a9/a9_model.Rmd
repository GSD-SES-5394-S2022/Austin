...
model_compare %>% filter(str_starts(purpose, "HBO")) %>%
...
```{r}
mode_constants %>% filter(trip_type == "HBO")
```
Initial run: -.75, .2, -4.5, -2.15, -4
First correction - -.5, 0, -3, 0, -2
Fix transit - -.5, 0, 0, 0.5, -2
Transit overcorrected - -.5, 0, -1.5, 0.5, -2
Nudge down SOV and Transit - -.75, -0.1, -1.75, 0.5, -1.5
Up SOV -.6, -0.1, -1.6, 0.5, -1.75
Up HOV slightly - -.6, 0, -1.6, 0.5, -1.75
Nudge - -.5, 0, -1.5, 0.6, -1.75
