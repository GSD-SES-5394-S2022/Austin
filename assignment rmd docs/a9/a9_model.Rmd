...
model_compare %>% filter(str_starts(purpose, "HBW")) %>%
...
```{r}
mode_constants %>% filter(trip_type == "HBW")
```
Let's try: 1, -1.5, -2.5, -2, -3
Not nearly enough. What if they were all 0s?
LOL - but we're STILL undercounting walking!
Try 1, -1, 1, 2, -1
Closer - try 0.5, -0.5, 2, 5, -0.5
Tweak - 0.75, -0.5, 2, 5, 0
Tweak - 0.85, -0.75, 2, 5, 0.25
Close! - 0.9, -0.75, 2, 4.5, 0.25